**Note:**
Please be aware that there will be limited/no support for self-hosting and apart from this wiki, you should figure out most stuff yourself. 

## Prerequisites
1. Create a bot on the [Discord Developer Portal]([https://discordapp.com/developers](https://discord.com/developers/applications))
2. Turn on **Server Members Intent** and **Message Content Intent** in the bot's settings page on the developer portal
...
## Terminal
1. Open your terminal and cd in the folder where bot files are located (`cd <DIRECTORY HERE>`, so in our case: `cd tutorial`
